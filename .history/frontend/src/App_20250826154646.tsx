...
type View = "login" | "upload" | "data" | "analysis" | "charts" | "export" | "admin";
            ...
            {excelData && (
              <div className="p-8 mt-12 transition-all duration-500 bg-white shadow-xl dark:bg-gray-800 rounded-2xl">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                  <OverviewCard
                    title="Total Rows"
                    value={excelData.stats.totalRows.toLocaleString()}
                    color="from-blue-500 to-purple-600"
                  />
                  <OverviewCard
                    title="Total Columns"
                    value={excelData.stats.totalColumns}
...
const OverviewCard = ({
  ...
  <div
    className={`p-6 text-white rounded-lg bg-gradient-to-r ${color} truncate`}
  >
