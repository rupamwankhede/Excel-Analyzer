...
//   const [activeTab, setActiveTab] = useState<"overview" | "users" | "files" | "history">("overview");
...
//     if (deleted) setLogs([`Deleted user: ${deleted.name}`, ...logs]);
//   };
...
//     if (deleted) setLogs([`Deleted file: ${deleted.name}`, ...logs]);
//   };
