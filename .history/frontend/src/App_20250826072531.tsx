...
import ExportPage from "./components/ExportPage";  // ✅ NEW
...
const App: React.FC = () => {
  ...
  const [activeView, setActiveView] = useState<
    "login" | "upload" | "data" | "analysis" | "charts" | "export"
  >("login");
  const [theme, setTheme] = useState(localStorage.getItem("xa_theme") || "light");
  ...
  return (
    ...
    >
      ...
      <main className="container px-4 py-8 mx-auto space-y-8">
        ...
        {/* Data, Analysis, Charts, Export views with filters */}
        {(activeView === "data" ||
          activeView === "analysis" ||
          activeView === "charts" ||
          activeView === "export") &&
